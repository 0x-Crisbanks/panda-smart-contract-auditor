...
class MultiBlockchainAuditor:
    ...
    def display_banner(self) -> None:
        ...
        # ASCII art style title similar to Gemini
        ...
        title_parts = [
            ("[cyan]>", ""),
            ("[cyan]P", "[bright_cyan]A"),
            ("[bright_cyan]N", "[blue]D"), 
            ("[blue]A", ""),
            (" ", ""),
            ("[bright_blue]W", "[magenta]E"),
            ("[magenta]B", "[bright_magenta]3")
        ]
        ...
        # Simple title layout without panda image
        title_art = """
[bright_cyan]██████╗  █████╗ ███╗   ██╗██████╗  █████╗     ██╗    ██╗███████╗██████╗ ██████╗ 
██╔══██╗██╔══██╗████╗  ██║██╔══██╗██╔══██╗    ██║    ██║██╔════╝██╔══██╗╚════██╗
██████╔╝███████║██╔██╗ ██║██║  ██║███████║    ██║ █╗ ██║█████╗  ██████╔╝ █████╔╝
